...
"C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\IDE\MSTest.exe" /testcontainer:"E:\Mvv\CASAT 4.0\Casat_4.0\TestAutomation\Casat4.0_Testing\Casat4.0_Testing\bin\Debug\testorderDIuser.orderedtest" /testsettings:"E:\Mvv\CASAT 4.0\Casat_4.0\TestAutomation\Casat4.0_Testing\settings.testsettings" >>"E:\Mvv\CASAT 4.0\Casat_4.0\TestAutomation\Casat4.0_Testing\TestResults\Summary.log"  
