...
{
    /// <summary>
    /// Summary description for batchEditProdBackbtn
    /// </summary>
    [TestClass]
    public class batchEditProdBackbtn : BaseTest
    {
        ...
        public void TestMethod_batchEditProdBack()
        {
            readData();
            ...
            Element backbuton = objproduct.backbtn;
            myManager.ActiveBrowser.Actions.Click(backbuton);

            Element redirect = objproduct.producttabletitle;
            Assert.IsTrue(redirect.InnerText.Contains("Products"));
