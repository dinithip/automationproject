...
{
    /// <summary>
    /// Summary description for SingleDeleteArticle
    /// </summary>
    [TestClass]
    public class SingleDeleteArticle : BaseTest
    {
