...
namespace Casat4._0_Testing.Testcases.ArticlesManagement.BatchEditArticle
{
    /// <summary>
    /// Summary description for BatchEditArticle
    /// </summary>
    [TestClass]
    public class BatchEditArticle : BaseTest
    {
