...
namespace Casat4._0_Testing.Testcases.ArticlesManagement.EditArticle
{
    ...
    public class EditArticle : BaseTest
    {
        ...
        public void updateArticle()
        {
            ...
            HtmlInputText artnum;
            HtmlInputText artname;
            HtmlInputText amt;
            Element updatebtn;

            artnum = myManager.ActiveBrowser.Find.ById("l0").As<HtmlInputText>();
            artname = myManager.ActiveBrowser.Find.ById("l1").As<HtmlInputText>();
            amt = myManager.ActiveBrowser.Find.ById("l4").As<HtmlInputText>();
            updatebtn = myManager.ActiveBrowser.Find.ByXPath("//*[@id='body']/div/div/div[2]/div/div/div/form/div[5]/div/div[2]/div[1]/input");
