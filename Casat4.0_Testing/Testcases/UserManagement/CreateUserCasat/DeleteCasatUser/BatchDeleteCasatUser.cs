...
{
    /// <summary>
    /// Summary description for BatchDeleteCasatUser
    /// </summary>
    [TestClass]
    public class BatchDeleteCasatUser : BaseTest
    {
        ...
        public void TestMethod_BatchDeleteCastUser()
        {
            readData();
            ...
            if (Usertable.BodyRows.Count > 0)
            {
                ...
                HtmlInputCheckBox firstrowcheck = objdelete.rowcheck1.As<HtmlInputCheckBox>();
                firstrowcheck.Check(true);

                HtmlInputCheckBox secondrowcheck = objdelete.rowcheck2.As<HtmlInputCheckBox>();
        ...
        public void readData()
        {
            ...
            _searchbatchdelete = TestContext.DataRow["searchbatchdelete"].ToString();
        }
