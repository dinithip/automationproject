...
{
    /// <summary>
    /// Summary description for BatchEditDeactiveUser
    /// </summary>
    [TestClass]
    public class BatchEditDeactiveUser : BaseTest
    {
        ...
        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "|DataDirectory|\\Data\\deactiveuser.csv", "deactiveuser#csv", DataAccessMethod.Sequential), DeploymentItem("Data\\deactiveuser.csv")]
        public void TestMethod_BatchDeactivateUser()
        {
            readData();
        ...
        public void batchDactivateUser()
        {
            ObjActiveDeactive objactive = new ObjActiveDeactive(myManager);
            ObjEditUser objedit = new ObjEditUser(myManager);
