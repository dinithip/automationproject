...
namespace Casat4._0_Testing.Testcases.CreateUserCasat.EditCasatUser
{
    /// <summary>
    /// Summary description for EditUser
    /// </summary>
    [TestClass]
    public class EditUser : BaseTest
    {
        ...
        public void updateUser()
        {
            ...
            HtmlInputText editfirstname;
            HtmlInputText editlastname;

            editfirstname = myManager.ActiveBrowser.Find.ById("l1").As<HtmlInputText>();
            editfirstname.Text = _firstname;

            editlastname = myManager.ActiveBrowser.Find.ById("l2").As<HtmlInputText>();
            editlastname.Text = _lastname;

            HtmlButton updatebtn;
            updatebtn = myManager.ActiveBrowser.Find.ByXPath("//*[@id='body']/div/div/div[2]/div/div/div/form/div[9]/div/div[2]/div[1]/input").As<HtmlButton>();
            updatebtn.Click();
