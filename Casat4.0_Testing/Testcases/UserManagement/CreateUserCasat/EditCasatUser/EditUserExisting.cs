...
{
    /// <summary>
    /// Summary description for EditUserExisting
    /// </summary>
    [TestClass]
    public class EditUserExisting : BaseTest
    {
        ...
        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "|DataDirectory|\\Data\\editExistingUsername.csv", "editExistingUsername#csv", DataAccessMethod.Sequential), DeploymentItem("Data\\editExistingUsername.csv")]
        ...
        public void readData()
        {
            ...
            _usernameexist = TestContext.DataRow["usernameexist"].ToString();
        }
