...
{
    /// <summary>
    /// Summary description for BatchEditDIActive
    /// </summary>
    [TestClass]
    public class BatchDIActive : BaseTest
    {
        ...
        public void updateBatchedit()
        {
            ...
            Assert.IsTrue(verifyconfirmation.InnerText.Contains("Are you sure you want to activate the selected user/s(4547, 4548)?"));
        ...
        public void verifybatchActive()
        {
            ...
            searchopid.Text = _searchoperatorid2;
            ...
            Assert.AreEqual(ditable.BodyRows[6].Cells[7].InnerText, _activestatus);
            Assert.AreEqual(ditable.BodyRows[7].Cells[7].InnerText, _activestatus);
        }
        ...
        public void readData()
        {
            ...
            _searchoperatorid2 = TestContext.DataRow["searchoperatorid2"].ToString();
            _activestatus = TestContext.DataRow["activestatus"].ToString();
        }
